...
export const environment = {
  production: false,
  api_url: "https://xexvjjrvjjxmgpbccipz.supabase.co/rest/v1/", // URL de la base de datos
  ...
  storage_url: "https://xexvjjrvjjxmgpbccipz.supabase.co" // URL correcta para el Storage
};
